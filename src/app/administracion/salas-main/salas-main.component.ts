 ...
 nuevaSala() {
  ...
  saveAsImage(parent: any) {
    ...
    if (parentElement) {
      ...
      let text = "";
      const pElement = document.getElementById("nombreSala") as HTMLParagraphElement;
      if (pElement){
        ...
        if (ctx) {
          ...
          ctx.drawImage(qrCanvas, 0, 0, parentRect.height, parentRect.height+pRect.height);
          ...
          ctx.fillText(text, parentRect.height / 2, parentRect.height + pRect.height / 2);
